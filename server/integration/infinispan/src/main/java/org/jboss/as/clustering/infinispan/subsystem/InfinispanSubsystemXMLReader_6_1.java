 ...
 */
public final class InfinispanSubsystemXMLReader_6_1 implements XMLElementReader<List<ModelNode>> {
   private static final Logger log = Logger.getLogger(InfinispanSubsystemXMLReader_6_1.class);
