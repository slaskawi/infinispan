...
public class DeployedCacheStoreFactoryService implements Service<CacheStoreFactory> {
   ...
   public void start(StartContext context) throws StartException {
      InfinispanLogger.ROOT_LOGGER.errorf("Starting DeployedCacheStoreFactoryService" + internalImplementation);
   }

   @Override
   public void stop(StopContext context) {
      InfinispanLogger.ROOT_LOGGER.errorf("Stopping DeployedCacheStoreFactoryService" + internalImplementation);
   }
