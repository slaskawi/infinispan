...
public class InfinispanQueryIT {
   ...
   public static Archive<?> deployment() {
      WebArchive archive = ShrinkWrap.create(WebArchive.class, "query.war").addClass(InfinispanQueryIT.class).addClass(TestEntity.class).add(manifest(), "META-INF/MANIFEST.MF");
      return archive;
   }
