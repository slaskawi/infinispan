...
public class PartitionStressTest extends MultipleCacheManagersTest {
   ...
   public void testWriteDuringPartition() throws Exception {
      ...
      final List<Future<Object>> futures = new ArrayList<Future<Object>>(NUM_NODES);
      ...
      while (splitIndex < NUM_NODES) {
         ...
         List<EmbeddedCacheManager> partitionOneManagers = new ArrayList<EmbeddedCacheManager>();
         List<EmbeddedCacheManager> partitionTwoManagers = new ArrayList<EmbeddedCacheManager>();
         for (int i = 0; i < NUM_NODES; i++) {
