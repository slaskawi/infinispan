...
//
   ...
   private void testSplitAndMerge(PartitionDescriptor p0, PartitionDescriptor p1) throws Exception {
      ...
      assertEquals(new HashSet<Address>(partitionHandlingManager(0).getLastStableCluster()), new HashSet<Address>(allMembers));
      assertEquals(new HashSet<Address>(partitionHandlingManager(1).getLastStableCluster()), new HashSet<Address>(allMembers));
      assertEquals(new HashSet<Address>(partitionHandlingManager(2).getLastStableCluster()), new HashSet<Address>(allMembers));
      assertEquals(new HashSet<Address>(partitionHandlingManager(3).getLastStableCluster()), new HashSet<Address>(allMembers));
