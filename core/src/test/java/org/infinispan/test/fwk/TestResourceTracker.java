...
public class TestResourceTracker {
   ...
   private static final EquivalentConcurrentHashMapV8<String, TestResources> testResources = new EquivalentConcurrentHashMapV8<String, TestResources>(AnyEquivalence.getInstance(), AnyEquivalence.getInstance());
