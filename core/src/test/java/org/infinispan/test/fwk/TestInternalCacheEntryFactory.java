...
public class TestInternalCacheEntryFactory {
   ...
   public static <K,V> InternalCacheEntry create(InternalEntryFactory factory, K key, V value, long lifespan) {
   ...
   public static <K,V> InternalCacheEntry create(InternalEntryFactory factory, K key, V value, long lifespan, long maxIdle) {
      //noinspection unchecked
