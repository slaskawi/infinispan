...
public class DependencyGraphTest {
   ...
   public void testLinear() throws CyclicDependencyException {
      ...
      assertEquals(sort.get(0),100);
      assertEquals(sort.get(100),0);
   }
   ...
   public void testAddSelf() {
      new DependencyGraph<Object>().addDependency("N", "N");
   }

   @Test(expectedExceptions = IllegalArgumentException.class)
   public void testAdNull() {
      new DependencyGraph<Object>().addDependency("N", null);
   }

   @Test(expectedExceptions = CyclicDependencyException.class)
   public void testCycle() throws CyclicDependencyException {
      DependencyGraph<Object> graph = new DependencyGraph<Object>();
