...
public class XSiteStateTransferManagerImpl implements XSiteStateTransferManager {
   ...
   public Map<String, String> getStatus() {
      return status.isEmpty() ? Collections.<String, String>emptyMap() : new HashMap<String, String>(status);
   }
   ...
   public <K, V> void handleTopology(TopologyChangedEvent<K, V> topologyChangedEvent) {
      ...
      Collection<String> missingCoordinatorSites = provider.getSitesMissingCoordinator(new HashSet<Address>(newMembers));
