...
public interface CommandsFactory {
   ...
   /**
    * Builds {@link org.infinispan.iteration.EntryRequestCommand} used to request entries from a remote node for
    * given segments
   ...
   /**
    * Builds {@link org.infinispan.iteration.EntryResponseCommand} use to respond with retrieved entries for
    * given segments
    * @param identifier The unique identifier for this entry retrieval request
