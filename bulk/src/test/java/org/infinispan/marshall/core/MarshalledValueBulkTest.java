...
public class MarshalledValueBulkTest extends MultipleCacheManagersTest {
   private static final Log log = LogFactory.getLog(MarshalledValueBulkTest.class);
   ...
   public void testAddMethodsForEntryCollection() {
      ...
      List<Map.Entry<Object, Object>> entryCollection = new ArrayList<Map.Entry<Object, Object>>(2);
   ...
   public void testRemoveAllMethodOfKeyCollection() {
      ...
      List<String> keyCollection = new ArrayList<String>(2);
   ...
   public void testRemoveAllMethodOfValuesCollection() {
      ...
      List<String> valueCollection = new ArrayList<String>(2);
   ...
   public void testRemoveAllMethodOfEntryCollection() {
      ...
      List<Map.Entry> entryCollection = new ArrayList<Map.Entry>(2);
   ...
   public void testRetainAllMethodOfEntryCollection() {
      ...
      List<Map.Entry> entryCollection = new ArrayList<Map.Entry>(3);
